    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-gray-800/50 border border-gray-700 rounded-lg p-6">
          <h3 className="text-sm font-medium text-gray-400 mb-2">Total Sectors</h3>
        ...
        <div className="bg-gray-800/50 border border-gray-700 rounded-lg p-6">
          <h3 className="text-sm font-medium text-gray-400 mb-2">Active Sectors</h3>
      ...
      {/* Sectors List */}
      <div className="mb-8">
        <h2 className="text-2xl font-semibold text-white mb-4">Sectors</h2>
        {sectors.length === 0 ? (
          <div className="bg-gray-800/50 border border-gray-700 rounded-lg p-6">
            <p className="text-gray-400">No sectors created yet.</p>
          </div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {sectors.map((sector) => (
              ...
              >
                <h3 className="text-lg font-medium text-white mb-2">{sector.name}</h3>
      ...
      {/* Recent Agents */}
      <div>
        <h2 className="text-2xl font-semibold text-white mb-4">Recent Agents</h2>
          ...
          <div className="bg-gray-800/50 border border-gray-700 rounded-lg overflow-hidden">
            <div className="divide-y divide-gray-700">
              {recentAgents.map((agent) => (
                <div key={agent.id} className="p-4 hover:bg-gray-800/70 transition-colors">
