...
from sqlalchemy import Column, String, DateTime, Float, Integer, ForeignKey, JSON, Table
...
class Agent(Base):
    ...
    personality = Column(JSON, nullable=False)  # Store AgentPersonality as JSON
